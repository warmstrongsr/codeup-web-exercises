(function () {
  ...
  describe("isIdentical", () => {
    ...
    it(
      "should return true when passed " + randomNumber + " and " + randomNumber,
      () => {
        expect(isIdentical(randomNumber, randomNumber)).toBe(true);
      }
    );
    it(
      "should return true when passed " +
        randomBoolean +
        " and " +
        randomBoolean,
      () => {
  ...
  describe("isEven", () => {
    ...
    it(
      "should return false when passed the boolean value " + randomBoolean,
      () => {
